...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO PESS", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	account := &openwallet.AssetsAccount{Alias: "mainnetPESS", WalletID: walletID, Required: 1, Symbol: "PESS", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	list, err := tm.CreateAddress(testApp, walletID, accountID, 3)
	if err != nil {
		log.Error(err)
		return
	}
